...
get_risc0_version() {
    ...
    if [[ "${RISC0_VERSION:?}" =~ ^1\.2\. ]]; then
        ...
        echo "unsupported risc0 version. version 1.2 is supported. please run 'rzup install cargo-risczero v1.2.X'. check https://github.com/risc0/risc0/releases for latest patch version."
        BRANCH=""
    fi
}
